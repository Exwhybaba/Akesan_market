import os
from sqlalchemy import create_engine, Column, Integer, String, Float, ForeignKey, Date, Text, Boolean, func, UniqueConstraint
from sqlalchemy.ext.declarative import declarative_base
from sqlalchemy.orm import relationship, sessionmaker
from datetime import datetime, date

# Delete existing database if it exists
if os.path.exists('market_management.db'):
    try:
        os.remove('market_management.db')
        print("Existing database deleted.")
    except:
        print("Could not delete the database file. Make sure it's not in use.")
        exit(1)
...
print("Database tables created successfully with the new schema.")
